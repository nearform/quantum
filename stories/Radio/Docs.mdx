...
export const RadioGroupDemo = ({
  ...
  return (
    <RadioGroup
      ...
      {...props}
    >
      <ControlLabel htmlFor={'helloId'} label="Hello">
        <Radio id={'helloId'} value="hello" />
      </ControlLabel>
      <ControlLabel htmlFor={'worldId'} label="World">
        <Radio id={'worldId'} value="world" />
      </ControlLabel>
      <ControlLabel htmlFor={'goodbyeId'} label="Goodbye">
        <Radio id={'goodbyeId'} value="goodbye" />
      </ControlLabel>
      <ControlLabel htmlFor={'friendId'} label="Friend">
        <Radio id={'friendId'} value="friend" />
      </ControlLabel>
    </RadioGroup>
  )
}
