...
```ts
<Checkbox checked=true className = "data-[state=checked]:text-yellow-200 data-[state=checked]:bg-grey-900">
```
...
Note that the colour of the tick, or minus is inherited from the parents text colour.
