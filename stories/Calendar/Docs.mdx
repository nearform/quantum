...
There are no extensions from React Day Pickers props to our own. In this sense, it is recommended to rely on the React Day Picker library for up to date information on the component.
